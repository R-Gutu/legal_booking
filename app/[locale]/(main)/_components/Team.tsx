  ...
  return (
        <div className={cn("flex bg-[#003D35] pb-[100px] pt-[60px]", "max-lg:flex-col max-md:py-[40px]")}>
            ...
            <div className={cn("flex flex-col gap-8 px-[100px] mt-10 justify-center h-[600px] relative z-10", "max-md:px-4 max-lg:mt-0")}>
                <h1 className={cn("text-6xl text-white font-bold text-left", "max-xl:text-4xl max-md:text-3xl max-lg:text-center")}>Echipa noastră juridică este pregătită să răspundă tuturor nevoilor tale</h1>
                <p className={cn("text-base text-start text-white/60 font-inter", "max-xl:text-sm max-lg:text-center")}>Oferim sprijin complet, de la înființare până la redactarea contractelor și gestionarea legală de zi cu zi. Totul rapid, clar și fără complicații.</p>
                <ul className={cn("grid grid-cols-2 gap-4 text-base font-inter font-semibold", "max-xl:grid-cols-1 max-sm:text-sm max-xl:self-center")}>
                    <li className={cn("text-white text-start flex gap-2 items-center")}>
                        <Image 
                            src="/svgs/star.svg"
                            alt="star"
                            width={20}
                            height={20}
                        />
                        Înființare sau lichidare SRL/IP în 3 zile
                    </li>
                    <li className="text-white text-start flex gap-2 items-center">
                        <Image 
                            src="/svgs/star.svg"
                            alt="star"
                            width={20}
                            height={20}
                        />
                        Contracte personalizate, redactare și revizuire
                    </li>
                    <li className="text-white text-start flex gap-2 items-center">
                        <Image 
                            src="/svgs/star.svg"
                            ...
                            height={20}
                        />
                        Suport complet pentru granturi, achiziții și licitații
                    </li>
                    <li className="text-white text-start flex gap-2 items-center">
                        <Image 
                            src="/svgs/star.svg"
                            ...
                            height={20}
                        />
                        Consultanță juridică pentru afaceri și familie
                    </li>
                </ul>
            ...
            <div className={cn("absolute top-[950px] right-[100px] z-10 flex flex-col gap-2 items-center", "max-xl:hidden")}>
                <p className="text-white font-inter font-semibold">Online consultație!</p>
                <Image 
